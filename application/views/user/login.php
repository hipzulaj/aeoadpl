...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/user/font-awesome/css/font-awesome.min.css') ?>">
		<link rel="stylesheet" href="<?php echo base_url('assets/user/css/form-elements.css') ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="<?php echo site_url('user/register/')?>" method="post" class="registration-form">
				                    	<div class="form-group">
